...
kernel void warp(texture2d<float, access::read> source [[texture(0)]], texture2d<float, access::write> destination [[texture(1)]], constant float2 &offset [[buffer(0)]], uint2 gid [[thread_position_in_grid]]) {
